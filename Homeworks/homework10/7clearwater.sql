...
-- revised 30/01/2024 Huu Con Nguyen
/ as sysdba
DROP USER c##des02 CASCADE;
CREATE USER c##des02 IDENTIFIED BY tiger;
GRANT connect , resource, create view TO c##des02;
ALTER USER c##des02 QUOTA 100M on USERs;
